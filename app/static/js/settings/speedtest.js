...
(function () {
    ...
    const formatBytes = window.WBShared?.formatBytes;
    if (typeof formatBandwidthMetric !== 'function' || typeof formatBytes !== 'function') {
        console.error('[SettingsSpeedtest] Required WBShared formatters not available');
        return;
    }
