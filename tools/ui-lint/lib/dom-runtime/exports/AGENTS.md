...
Schema/diff exports of a snapshot.

## Key Files

| File | Description |
|---|---|
| `compact-schema.mjs` | `buildCompactSchema` |
| `verbose-schema.mjs` | `buildVerboseSchema` |
| `snapshot-diff.mjs` | `diffSnapshots(current, previous)` |
