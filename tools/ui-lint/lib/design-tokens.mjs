...
export function loadDesignTokens() {
    ...
    return {
        ...
        interaction: {
            ...
            touchTargetMinMobile: getPx('--wb-touch-target-min-mobile') || getPx('--wb-touch-target-min'),
            touchTargetMinTablet: getPx('--wb-touch-target-min-tablet') || getPx('--wb-touch-target-min'),
            touchTargetMinDesktop: getPx('--wb-touch-target-min-desktop') || getPx('--wb-touch-target-min'),
